...
for s in samples:
    ...
    isFakeYld = hist.GetBinContent(1)
    isFlipYld = hist.GetBinContent(2)
    isOtherYld = hist.GetBinContent(3)
    isFakeErr = hist.GetBinError(1)
    isFlipErr = hist.GetBinError(2)
    isOtherErr = hist.GetBinError(3)
