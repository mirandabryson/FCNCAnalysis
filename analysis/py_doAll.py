...
if __name__ == "__main__":
    ...
    chs = {
        2016: {
            "fakes": make_obj([
                basedirs[2016]+get_sample_path("data",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttw",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttz_m1-10",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttz_m10",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("tth_nobb",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("qqww",2016,args.tag)+"/{}/*.root".format(2016),
                ] , options=options[2016]+" doFakes doData "),
            "flips": make_obj(basedirs[2016]+get_sample_path("data",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016]+" doFlips doData "),
            "data": make_obj(basedirs[2016]+get_sample_path("data",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016] + " doData "),
            "signal_tuh": make_obj(basedirs[2016]+get_sample_path("signal_hut_atop",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016]),
            "signal_tuh": make_obj(basedirs[2016]+get_sample_path("signal_hut_top",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016]),
            "signal_tch": make_obj(basedirs[2016]+get_sample_path("signal_hct_atop",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016]),
            "signal_tuh": make_obj(basedirs[2016]+get_sample_path("signal_hct_top",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016]),
            # "fakes_mc": make_obj(basedirs[2016]+get_sample_path("TTBAR*",2016)+"/{}/*.root".format(2016), options=options[2016]+ " doFakesMC "),
            "fakes_mc": make_obj([
                basedirs[2016]+get_sample_path("ttjets",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wjets_ht100-200",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wjets_ht200-400",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wjets_ht400-600",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wjets_ht600-800",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wjets_ht800-1200",2016,args.tag)+"/{}/*.root".format(2016),
                ] , options=options[2016]+ " doTruthFake doStitch "),
            "flips_mc": make_obj([
                basedirs[2016]+get_sample_path("dyjets_m10-50",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("dyjets_m50", 2016,args.tag) + "/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ww", 2016,args.tag) + "/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttjets", 2016,args.tag) + "/{}/*.root".format(2016),
                ], options=options[2016]+"doTruthFlip doStitch"),
            "ttw": make_obj(basedirs[2016]+get_sample_path("ttw",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016]),
            "tth": make_obj(basedirs[2016]+get_sample_path("tth_nobb",2016,args.tag)+"/{}/*.root".format(2016), options=options[2016]),
            "ttz": make_obj([
                basedirs[2016]+get_sample_path("ttz_m1-10",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttz_m10",2016,args.tag)+"/{}/*.root".format(2016),
                ] , options=options[2016]),
            "xg": make_obj([
                basedirs[2016]+get_sample_path("tg",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttg_dilep",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttg_1lep",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wg",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("zg",2016,args.tag)+"/{}/*.root".format(2016),
                ],options=options[2016] + " doXgamma "),
            "ttvv": make_obj([
                basedirs[2016]+get_sample_path("tthh",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttwh",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttww",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttwz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttzh",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("ttzz",2016,args.tag)+"/{}/*.root".format(2016),
                ],options=options[2016]),
            "rares": make_obj([
                basedirs[2016]+get_sample_path("ggh",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("qqww",2016,args.tag)+"/{}/*.root".format(2016),
                #basedirs[2016]+get_sample_path("twz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("tzq",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("vh_nobb",2016,args.tag)+"/{}/*.root".format(2016),
                #basedirs[2016]+get_sample_path("ww_dps",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("www",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wwz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wzg",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wwg",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("wzz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("zz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("zzz",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("tttj",2016,args.tag)+"/{}/*.root".format(2016),
                basedirs[2016]+get_sample_path("tttw",2016,args.tag)+"/{}/*.root".format(2016),
                    basedirs[2016]+get_sample_path("tttt",2016,args.tag)+"/{}/*.root".format(2016),
                ],options=options[2016]),
            },
        2017: {
            "fakes": make_obj([
