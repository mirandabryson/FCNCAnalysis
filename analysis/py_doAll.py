...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--datatag", help="tag for bookkeeping and output directory location", default="fcnc_v4")
    ...
    chs = {
        ...
        2017: {
            ...
            "signal_tch": make_obj([
                ...
                ] , options=options[2017]),           # "fakes_mc": make_obj(basedirs[2017]+get_sample_path("TTBAR*",2017,args.tag)+".root", options=options[2017]+ " doFakesMC "),
            "fakes_mc": make_obj([
