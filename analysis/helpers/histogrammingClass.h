...
class HistContainer {
    ...
    public:
        ...
        void fill(std::string sample, int best_hyp_type, Leptons &leps, Jets &jets, Jets &bjets, float met, bool isVR_SR, bool isVR_CR, bool isEE, bool isEM, bool isME, bool isMM, bool isEFake, bool isMFake, float weight=1., float crWeight=1.);
};
