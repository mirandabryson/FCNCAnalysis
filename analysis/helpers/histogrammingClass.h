...
class HistContainer {
    ...
    public:
        ...
        void fill(std::string sample, int best_hyp_type, Leptons &leps, Jets &jets, Jets &bjets, float met, bool isVR_SR_fake, bool isVR_CR_fake, bool isVR_SR_flip, bool isVR_CR_flip, bool isEE, bool isEM, bool isME, bool isMM, bool isEFake, bool isMFake, float weight=1., float crWeight=1.);
};
